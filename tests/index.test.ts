...
describe("Box Shadow", () => {
  test("Box Shadow Focus", () => {
    expect(
      DoWork("./tests/box-shadow/box-shadow-focus.html", {}, {})
    ).toContain(
  ...
  test("Box Shadow Snapping", () => {
    expect(
      DoWork("./tests/box-shadow/box-shadow-snapping.html", {}, {})
    ).toContain(
  ...
  test("Box Shadow Custom Button", () => {
    expect(
      DoWork("./tests/box-shadow/box-shadow-custombutton.html", {}, {})
    ).toContain(
      `.btn {\r\n\tbox-shadow: ${BoxShadowSizes.sm} ${BoxShadowSizes.sm};\r\n}`
    );
  });
  ...
  test("Box Shadow Media Large", () => {
    expect(
      DoWork("./tests/box-shadow/box-shadow-media.html", {}, {})
    ).toContain(
...
describe("Custom Classes", () => {
  test("Mybutton - One", () => {
    expect(
      DoWork("./tests/custom-classes/my-button-one.html", {}, {})
    ).toContain(`.mybtn {\r\n\tfont-size: ${FontSizes.xl};\r\n}`);
  });

  test("Mybutton - Two", () => {
    expect(
      DoWork("./tests/custom-classes/my-button-two.html", {}, {})
    ).toContain(
      `.mybtn {\r\n\tfont-size: ${FontSizes.xl};\r\n\tdisplay: flex;\r\n}`
    );
  });
  ...
  test("Mybutton - Three", () => {
    expect(
      DoWork("./tests/custom-classes/my-button-three.html", {}, {})
    ).toContain(
...
describe("Border Style", () => {
  ...
  test("Border Style - Large", () => {
    expect(
      DoWork("./tests/border-style/border_style_media_large.html", {}, {})
    ).toContain(
  ...
  test("Border Style - Small", () => {
    expect(
      DoWork("./tests/border-style/border_style_media_small.html", {}, {})
    ).toContain(
...
describe("Border Radius", () => {
  test("Border Radius Snapping - XS", () => {
    expect(
      DoWork("./tests/border-radius/border_radius_xs.html", {}, {})
    ).toContain(
  ...
  test("Border Radius Snapping - SM", () => {
    expect(
      DoWork("./tests/border-radius/border_radius_sm.html", {}, {})
    ).toContain(
  ...
  test("Border Radius Snapping - XL", () => {
    expect(
      DoWork("./tests/border-radius/border_radius_xl.html", {}, {})
    ).toContain(
...
describe("flex direction", () => {
  ...
  test("flex direction with Media Small", () => {
    expect(
      DoWork("./tests/flex/flex_direction_media_small.html", {}, {})
    ).toContain(
...
describe("Border", () => {
  ...
  test("Border Width 10px 10px", () => {
    expect(
      DoWork("./tests/border-width/border_10px10px.html", {}, {})
    ).toContain(
  ...
  test("Border Width lg xl xs xs", () => {
    expect(
      DoWork("./tests/border-width/border_lgxlxsxs.html", {}, {})
    ).toContain(
