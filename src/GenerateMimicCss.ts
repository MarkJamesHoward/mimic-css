...
export function GenerateMimicClass_NONMEDIA_Return_ClassName_Separate(
  source: string,
  style: string,
  value1: string,
  value2: string,
...
export function GenerateMimicClass_ReturnDistinctMediaAndCSS(
  source: string,
  style: string,
  value1: string,
  value2: string,
  ...
  return {
    ...
    mediaClass: { className: className, css: css },
  };
}
