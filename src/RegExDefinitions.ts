...
export const single_hyphen_then_colon_snappable =
  /^(?<media>extrasmall\?|small\?|medium\?|large\?|extralarge\?)?(?<style>[A-Za-z]+-[A-Za-z]+):(?<value1>xs|sm|md|lg|xl|2xl|c1|2|c3|c4|c5)(?<value2>xs|sm|md|lg|xl|2xl|c1|2|c3|c4|c5)?(?<value3>xs|sm|md|lg|xl|2xl|c1|2|c3|c4|c5)?(?<value4>xs|sm|md|lg|xl|2xl|c1|2|c3|c4|c5)?(?<pseudo>:hover|:focus)?(?<customclass>\@[A-Za-z0-9]+(?<customclass_subgroup_pseudo>:hover|:focus)?)?$/gi;
...
export const no_hyphen_snappable =
  /^(?<media>extrasmall\?|small\?|medium\?|large\?|extralarge\?)?(?<style>[A-Za-z]+):(?<value1>xs|sm|md|lg|xl|2xl|c1|2|c3|c4|c5)(?<value2>xs|sm|md|lg|xl|2xl|c1|2|c3|c4|c5)?(?<value3>xs|sm|md|lg|xl|2xl|c1|2|c3|c4|c5)?(?<value4>xs|sm|md|lg|xl|2xl|c1|2|c3|c4|c5)?(?<pseudo>:hover|:focus)?(?<customclass>\@[A-Za-z0-9]+(?<customclass_subgroup_pseudo>:hover|:focus)?)?$/gi;
