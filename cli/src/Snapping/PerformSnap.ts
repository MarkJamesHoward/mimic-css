...
export function PerformSnap(type: string, value: string) {
  ...
  switch (type) {
    ...
    case "background":
      switch (value) {
        case mimicConfig?.ColorPalette5TextOverride?.colora ?? ColorSizes.c5a:
          result =
        ...
        case mimicConfig?.ColorPalette5TextOverride?.colorc ?? ColorSizes.c5c:
          result =
            mimicConfig?.ColorPalette5Snapping?.c1c ??
            color_palette_5.c5background1;
          break;

        case mimicConfig?.ColorPalette5TextOverride?.colord ?? ColorSizes.c5d:
          result =
            mimicConfig?.ColorPalette5Snapping?.c1d ??
            color_palette_5.c5background2;
          break;

        case mimicConfig?.ColorPalette5TextOverride?.colore ?? ColorSizes.c5e:
          result =
